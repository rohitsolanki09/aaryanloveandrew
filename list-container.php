            ...
            <div class="tab-pane fade show active" id="pills-to-do-list" role="tabpanel" aria-labelledby="pills-to-do-list-tab" tabindex="0">
                <div class="update-button-row">
                    <div class="card-action-btns-start">
                        ...
                        <a href=""><span class="btn-img badge text-btn fw-semibold bg-dark-danger-gradient text-white"><iconify-icon icon="proicons:delete" class="text-xl"></iconify-icon> FINALIZE CONTAINER</span></a>
                    </div>
                    <div class="card-action-btns-start">
                    <a href=""><span class="btn-img badge text-btn fw-semibold bg-dark-primary-gradient text-white"><iconify-icon icon="octicon:container-16" class="text-xl"></iconify-icon> FINALIZE CONTAINER</span></a>
                    </div>
                </div>
            </div>
        </div>
