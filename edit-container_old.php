...
<div class="dashboard-main-body">
    <div class="dashboard-main-body">
        ...
        <div class="checkbox-wrapper">
            <label for="finalizeC1">
                <input type="checkbox" id="finalizeC1" name="finalizeC1">
                Do you want to Finalize the Container "C1"?
            </label>
        </div>


        <div class="row gy-4 mt-0"><label>
                <div class="tab-pane fade show active" id="pills-to-do-list" role="tabpanel" aria-labelledby="pills-to-do-list-tab" tabindex="0">
                    <div class="update-button-row">
                        <div class="card-action-btns-start">
                            <a href=""><span class="btn-img badge text-btn fw-semibold bg-dark-primary-gradient text-white"><iconify-icon icon="mynaui:save" class="text-xl"></iconify-icon> UPDATE CONTAINER</span></a>
                            <a href="#" data-popup="finalizePopup"><span class="btn-img badge text-btn fw-semibold bg-dark-primary-gradient text-white"><iconify-icon icon="octicon:container-16" class="text-xl"></iconify-icon> FINALIZE CONTAINER</span></a>
                        </div>
                        <div class="card-action-btns-start">
                            <a href=""><span class="btn-img badge text-btn fw-semibold bg-dark-danger-gradient text-white"><iconify-icon icon="proicons:delete" class="text-xl"></iconify-icon> DELETE</span></a>
                        </div>
                    </div>
                </div>
        </div>
